...
from cipher.caesar import CaesarCipher  # <--- Thêm dòng này

app = Flask(__name__)  # BỔ SUNG DÒNG NÀY

vigenere_cipher = VigenereCipher()
railfence_cipher = RailFenceCipher()
playfair_cipher = PlayFairCipher()
caesar_cipher = CaesarCipher()  # <--- Thêm dòng này
